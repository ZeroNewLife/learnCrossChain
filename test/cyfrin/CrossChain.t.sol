//Учитывая проблему что я описал выше большая часть функций не будут работать тупо так как нету ничего в тех классах
//но любой желающий  у кого работает в старых версиях может взять этот код и запустить у себя

//но условно какой смысл тестит тут если условно в новых он не сработает тобиж писать код который не работает?
//я хз условно оставляю функции тесты прописал основная логика имеется
